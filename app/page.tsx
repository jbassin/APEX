...
const primary = genSpan("text-primary-focus");
const secondary = genSpan("text-secondary-focus");
const accent = genSpan("text-accent-focus");
            ...
            <div className="flex flex-col min-h-screen my-4">
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <p className="mb-5 basis-1/2">
                        ...
                        one-shot style play. You'll need ten ten-sided dice
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            general categories: {primary("Psyche")},{" "}
                            {secondary("Physicality")}, and {accent("Potency")}.
                            A {primary("Psyche")} approach means a PC emphasizes
                            using their mind and forethought, a{" "}
                            {secondary("Physicality")} approach means the PC
                            relies more on their physical body, and a{" "}
                            {accent("Potency")} approach means the PC uses their
                            magic more directly. As an example:{" "}
                            {italic("Tracker")} wants to locate a runaway
                            thrall. If {italic("Tracker")} hid a trace on the
                            thrall before it escaped, she'd use a{" "}
                            {accent("Potency")} approach. If {italic("Tracker")}{" "}
                            went looking for footprints or broken branches, she
                            'd use a {secondary("Physicality")} approach. If{" "}
                            {italic("Tracker")} imagined how the thrall might
                            act and attempted to predict its movements, she 'd
                            use a {primary("Psyche")} approach.
                        </p>
                        <br />
                        <p>
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            A PC's {primary("Composure")} is its ability to
                            shrug off attempts to control or influence its
                            actions and how well it can convincingly misdirect
                            others. Some examples that use the{" "}
                            {primary("Composure")} ability are avoiding being
                            stunned by an EMP and convincing an inquisitor of
                            your innocence.
                        </p>
                        <br />
                        <p>
                        ...
                        <p>
                            ...
                            A PC's {primary("Wit")} is its ability to recall and
                            learn information. Some examples that use the{" "}
                            {primary("Wit")} ability are learning the true name
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            A PC's {secondary("Endurance")} is its ability to
                            ...
                            {secondary("Endurance")} ability are descending into
                            the heart of a singularity and holding a continent
                        ...
                        <p>
                            ...
                            A PC's {secondary("Agility")} is its ability to move
                            with speed and grace. Some examples that use the{" "}
                            {secondary("Agility")} ability are slicing a paladin
                            in half before he can draw his blade and piloting an
                            imperial starcraft through a dense asteroid field.
                        </p>
                        <br />
                        <p>
                            {secondary("Power")}.{" "}
                            ...
                            A PC's {secondary("Power")} is its ability to exert
                            pressure on objects or command fear and respect
                            among its followers. Some examples that use the{" "}
                            {secondary("Power")} ability are shattering an
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            A PC's {accent("Shivers")} is its ability to
                            perceive the world around it and the effect
                            technology or magic has on reality. Some examples
                            that use the {accent("Shivers")} ability are seeking
                            the location of the last rebels in their underground
                            base and tracing the flow of mana in a broken
                            magicircuit.
                        </p>
                        <br />
                        <p>
                            ...
                            A PC's {accent("Volition")} is its ability to
                            generate or destroy matter and energy. Some examples
                            that use the {accent("Volition")} ability are
                        ...
                        <p>
                            ...
                            A PC's {accent("Interfacing")} is its ability to
                            connect with magical mechanisms and intricate
                            machines. Some examples that use the{" "}
                            {accent("Interfacing")} ability are convincing an
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            {primary("Psyche")}({primary("⦿⦿")})+
                            {primary("Rhetoric")}({primary("⦿⦿⦿")}) roll and
                            sets the difficulty at three. {italic("Despair")}{" "}
                            has five pips between her approach and ability, so
                            she rolls five dice. She gets two successes, which
                            ...
                            roll a {secondary("Physicality")}({secondary("⦿⦿⦿")}
                            )+
                            {secondary("Power")}({secondary("⦿⦿⦿⦿⦿⦿")}) roll and
                            keeps the difficulty at 3. {italic("Anger")} rolls
                            nine dice and gets six successes. As such, he
                ...
                <div className="flex flex-row gap-4 text-neutral-content py-8">
                    ...
                    <div className="mb-5 basis-1/2">
                        ...
                        <p>
                            ...
                            {primary("Psyche")}, two to potency, and one to{" "}
                            {secondary("Physicality")}. Since that makes{" "}
                            {primary("Psyche")}-associated abilities have a max
                            of five pips, she puts five in{" "}
                            {primary("Composure")} and {primary("Rhetoric")} and
                            three in {primary("Wit")}.{" "}
                            {secondary("Physicality")}-associated abilities have
                            a maximum of three pips, so she arranges two in
                            each. {accent("Potency")}-associated abilities have
                            a max of four pips; she puts three in{" "}
                            {accent("Shivers")} and {accent("Volition")} and two
                            in {accent("Interfacing")}. Finally, she selects{" "}
                            {primary("Composure")} as her specialty, bringing
                            the pip total to six for that ability.
                        </p>
                        <br />
                        <p>
                    ...
                    <div className="flex flex-row gap-4 my-4">
                        <div>
                            {Object.keys(aptitudes).filter(
                                ...
                                <span>
                                    Drag these pips to the<br></br>approaches
                                    outlined below.
                                </span>
                            )}
                        </div>
